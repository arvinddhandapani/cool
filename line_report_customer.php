...
<head>
	...
	<script>
	 $(document).ready(function(){
	  $("#field3").autocomplete("includes/autocomplete_line.php", {
	        selectFirst: true
	  });
	 });
	</script>
...
<div class="TTWForm-container">
     ...
     <form action="includes/line_credit_report_process.php" id="my" target="_blank" class="TTWForm" method="post" novalidate="">
